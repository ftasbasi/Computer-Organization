...
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL ,IIADDQ};	# We added IIADDQ here because we need immediate values which is stored in valC for this architecture
...
word d_srcB = [
	D_icode in { IOPQ, IRMMOVQ, IMRMOVQ ,IIADDQ } : D_rB;			# We added IIADDQ here because we use registers for ADD operation which stores register into rB
...
word d_dstE = [
	D_icode in { IRRMOVQ, IIRMOVQ, IOPQ, IIADDQ} : D_rB;			# We added IIADDQ here because we store register and immediate sums into valE which is stored in rB
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ ,IIADDQ } : E_valC;		# First argument of ALU is valC
...
word aluB = [
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ ,IIADDQ } : E_valB;				# Second argument of ALU is valB
...
bool set_cc = E_icode in {IOPQ, IIADDQ } &&							# We need to set Condition Codes because we do arithmetic addition operation.
